...
public class GetTypeArgumentsFromInterfaceTest {
	...
	public void testGetTypeArgumentsFromInterfaceA() {
		Assert.assertArrayEquals(new Object[]{Type1.class},
				GenericsUtils.getTypeArguments(ClassA1.class, InterfaceA1.class).toArray());
	}

	@Test
	public void testGetTypeArgumentsFromInterfaceB() {
		Assert.assertArrayEquals(new Object[]{Type1.class},
				GenericsUtils.getTypeArguments(ClassB2.class, InterfaceB1.class).toArray());
	}

	@Test
	public void testGetTypeArgumentsFromInterfaceC() {
		Assert.assertArrayEquals(new Object[]{Type1.class},
				GenericsUtils.getTypeArguments(ClassC2.class, InterfaceC1.class).toArray());
	}

	@Test
	public void testGetTypeArgumentsFromInterfaceD() {
		Assert.assertArrayEquals(new Object[]{Type1.class},
				GenericsUtils.getTypeArguments(ClassD2.class, InterfaceD1.class).toArray());
	}
