...
public class GetTypeArgumentsFromSuperClassTest
{
	...
	{
		Assert.assertArrayEquals(new Object[] { Type1.class }, GenericsUtils.getTypeArguments(ClassA2.class, ClassA1.class).toArray());
	}

	@Test
	public void testGetTypeArgumentsFromSuperclassB()
	{
		Assert.assertArrayEquals(new Object[] { Type1.class }, GenericsUtils.getTypeArguments(ClassB3.class, ClassB1.class).toArray());
	}
