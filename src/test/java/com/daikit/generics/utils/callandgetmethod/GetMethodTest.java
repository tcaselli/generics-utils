...
public class GetMethodTest {
	...
	public void testGet2Args() {
		Assert.assertEquals(Result3.class,
				GenericsUtils.getMethod(Class1.class, "test", int.class, String.class).getReturnType());
	}

	@Test
	public void testGet3ArgsWithVarargs() {
		Assert.assertEquals(Result5.class, GenericsUtils
				.getMethod(Class1.class, "test", String.class, String.class, String[].class).getReturnType());
	}

	@Test
	public void testGet2ArgsWithInheritance() {
		Assert.assertEquals(Result6.class,
				GenericsUtils.getMethod(Class1.class, "test", int.class, Double.class).getReturnType());
	}

	@Test
	public void testGet1ArgsWithInterface() {
		Assert.assertEquals(Result7.class,
				GenericsUtils.getMethod(Class1.class, "test", InterfaceParam1.class).getReturnType());
	}

	@Test
	public void testGet1ArgsWithInterfaceAndInheritance() {
		Assert.assertEquals(Result8.class,
				GenericsUtils.getMethod(Class1.class, "test", InterfaceParam2.class).getReturnType());
	}

	@Test
	public void testGet1ArgsWithInterfaceAndInheritanceAndAmbiguity() {
		Assert.assertEquals(Result9.class,
				GenericsUtils.getMethod(Class1.class, "test", InterfaceParam4.class).getReturnType());
	}

	@Test
	public void testGet1ArgsWithClass() {
		Assert.assertEquals(Result10.class,
				GenericsUtils.getMethod(Class1.class, "test", ClassParam1.class).getReturnType());
	}

	@Test
	public void testGet1ArgsWithClassAndInheritance() {
		Assert.assertEquals(Result11.class,
				GenericsUtils.getMethod(Class1.class, "test", ClassParam2.class).getReturnType());
	}

	@Test
	public void testGet1ArgsWithClassAndInheritanceAndAmbiguity() {
		Assert.assertEquals(Result12.class,
				GenericsUtils.getMethod(Class1.class, "test", ClassParam4.class).getReturnType());
	}

	@Test
	public void testGet1ArgWithExtension() {
		Assert.assertEquals(Result13.class,
				GenericsUtils.getMethod(Class2.class, "test", String.class).getReturnType());
	}

	@Test
	public void testGet3ArgWithVarargsAndAmbiguity() {
		Assert.assertEquals(Result14.class, GenericsUtils
				.getMethod(Class1.class, "test", String.class, String.class, Integer[].class).getReturnType());
	}

	@Test
	public void testGet3ArgWithSuperclassAndVarargsAndAmbiguity() {
		Assert.assertEquals(Result15.class, GenericsUtils
				.getMethod(Class1.class, "test", String.class, String.class, Object[].class).getReturnType());
	}

	@Test
	public void testGet3ArgWithInterfaceAndVarargs() {
		Assert.assertEquals(Result16.class, GenericsUtils
				.getMethod(Class1.class, "test", String.class, String.class, InterfaceParam1[].class).getReturnType());
	}

	@Test
	public void testGet3ArgWithInterfaceAndVarargsAndAmbiguity() {
		Assert.assertEquals(Result17.class, GenericsUtils
				.getMethod(Class1.class, "test", String.class, String.class, InterfaceParam2[].class).getReturnType());
	}

	@Test
	public void testGet3ArgWithInterfaceAndVarargsAndAmbiguity2() {
		Assert.assertEquals(Result17.class, GenericsUtils
				.getMethod(Class1.class, "test", String.class, String.class, InterfaceParam3[].class).getReturnType());
	}

	@Test
	public void testGet3ArgWithCustomClassAndVarargs() {
		Assert.assertEquals(Result18.class, GenericsUtils
				.getMethod(Class1.class, "test", String.class, String.class, ClassParam1[].class).getReturnType());
	}

	@Test
	public void testGet3ArgWithCustomClassAndVarargsAndAmbiguity() {
		Assert.assertEquals(Result19.class, GenericsUtils
				.getMethod(Class1.class, "test", String.class, String.class, ClassParam2[].class).getReturnType());
	}

	@Test
	public void testGet3ArgWithCustomClassAndVarargsAndAmbiguity2() {
		Assert.assertEquals(Result19.class, GenericsUtils
				.getMethod(Class1.class, "test", String.class, String.class, ClassParam3[].class).getReturnType());
	}
