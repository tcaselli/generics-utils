...
public class GetTypeArgumentsFromFieldTest {
	...
	public void testGetTypeArgumentsFromFieldA1OneResult() throws NoSuchFieldException, SecurityException {
		Assert.assertEquals(Type1.class,
				GenericsUtils.getFieldTypeArgument(ClassA1.class, ClassA1.class.getDeclaredField("test1")));
	}
	...
	public void testGetTypeArgumentsFromFieldB2_3() throws NoSuchFieldException, SecurityException {
		Assert.assertEquals(Object.class,
				GenericsUtils.getFieldType(ClassB1.class, ClassB1.class.getDeclaredField("test3")));
	}

	@Test
	public void testGetTypeArgumentsFromFieldB2_4() throws NoSuchFieldException, SecurityException {
		Assert.assertEquals(Type2.class,
				GenericsUtils.getFieldType(ClassB2.class, ClassB1.class.getDeclaredField("test3")));
	}
}
